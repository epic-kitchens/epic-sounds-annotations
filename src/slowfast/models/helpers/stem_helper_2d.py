...
class ResNetBasicStem(nn.Module):
    ...
    def _construct_stem(self, dim_in, dim_out, norm_module):
        # This is modified than the original to use stride of 2 in time as well
        # in both conv and pooling layers such that the output from this is
        # 8/32 in time for slow/fast, same as the video inputs in time.
        # (works for inputs with time dimension = 128)
        self.conv = nn.Conv2d(
            dim_in,
            dim_out,
            self.kernel,
