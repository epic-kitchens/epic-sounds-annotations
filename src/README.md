...
The dataset in this codebase uses a [HDF5 Audio Dataset](https://epic-kitchens.github.io/epic-sounds/) containing all the raw audio samples from the [EPIC-KITCHENS-100](https://epic-kitchens.github.io/2022) videos. To install, complete the steps as follow:
